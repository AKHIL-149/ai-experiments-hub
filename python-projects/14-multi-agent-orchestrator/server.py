...
app.include_router(secret_management.router, prefix="/api/secrets", tags=["Secret Management"])
app.include_router(api_rate_limiting.router, prefix="/api/quotas", tags=["API Rate Limiting"])
app.include_router(data_retention.router, prefix="/api/retention", tags=["Data Retention"])
...
app.include_router(agent_versioning.router, prefix="/api/versioning", tags=["Agent Versioning"])
app.include_router(testing_framework.router, prefix="/api/testing", tags=["Testing Framework"])
app.include_router(api_documentation.router, prefix="/api/documentation", tags=["API Documentation"])
app.include_router(deployment_orchestration.router, prefix="/api/deployment", tags=["Deployment"])
app.include_router(environment_config.router, prefix="/api/environment", tags=["Environment Config"])
app.include_router(database_migration.router, prefix="/api/migrations", tags=["Database Migrations"])
app.include_router(monitoring_observability.router, prefix="/api/monitoring", tags=["Monitoring & Observability"])
app.include_router(log_aggregation.router, prefix="/api/logs", tags=["Log Aggregation"])
app.include_router(performance_optimization.router, prefix="/api/performance", tags=["Performance Optimization"])
app.include_router(capacity_planning.router, prefix="/api/capacity", tags=["Capacity Planning"])
...
app.include_router(api_gateway.router, prefix="/api/gateway", tags=["API Gateway"])
app.include_router(feature_flags.router, prefix="/api/feature-flags", tags=["Feature Flags"])
app.include_router(data_privacy.router, prefix="/api/privacy", tags=["Data Privacy"])
app.include_router(webhook_management.router, prefix="/api/webhooks", tags=["Webhook Management"])
app.include_router(notification_service.router, prefix="/api/notifications", tags=["Notifications"])
app.include_router(search_indexing.router, prefix="/api/search", tags=["Search & Indexing"])
app.include_router(analytics_dashboard.router, prefix="/api/dashboards", tags=["Analytics Dashboards"])
...
app.include_router(integration_testing.router, prefix="/api/testing", tags=["Integration Testing"])
